...
var Blinn_Phong = Object.create(Shader);
var vsSource = `
...
`;
Blinn_Phong.setSources(vsSource,fsSource);
Blinn_Phong.getUniformLocations = function(){
    this.getLoc("mvp");
...
Blinn_Phong.setUniforms = function(model,view,projection,material){
