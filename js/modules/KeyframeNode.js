...
function TransformKeyFrames(t_keys,r_keys,s_keys){
    //sorting function
...
function Node (material,model,name,mesh = null,keyframes = null) {
    this.name = name;
    this.GpuMesh = mesh;
    ...
    // draw function 
    this.draw = function(shader,model,view,projection,time){
        ...
        if(mesh!=null){
            ...
            this.GpuMesh.draw(shader.gl);
        }
        // draw its children with an updated modeling matrix
        this.children.forEach(child => {
            child.draw(shader,m,view,projection);
        });
    }
 }